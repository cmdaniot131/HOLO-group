...
<main>
  <div class="container py-4">
	...
	<div class="py-4 text-center" id="products">
        ...
        <div class="py-4 container">
            ...
            <%
				...
				String password = "h398zl6G$Zkz";
				String database = "727_db";
			...
			<%
                ...
                <div class="col-3 p-3 rounded">
                    <img src="<%=rs.getString("Image_URL")%>" class="img-fluid">
                    <h4><%=rs.getString("Name")%></h4>
                    <p>PHP <%=rs.getString("Price")%></p>
                    <form method="post" action="CartProdSubmit.jsp"><input type="hidden" name="Product_ID" value="<%=rs.getInt("Product_ID")%>"> <button class="btn btn-dark" type="submit">Add To Cart</button><input class="ps-3" type="number" name="qty" min="1" value="1"></form>
                </div>
