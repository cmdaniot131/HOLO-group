...
String sql ="SELECT Products.Name, Products.Price, Cart.qty, Cart.Order_ID FROM Cart INNER JOIN Products ON Cart.Product_ID = Products.Product_ID WHERE Order_ID = " + id;
resultSet = statement.executeQuery(sql);
while (resultSet.next()) {
%>
<form method="post" action="CartUpdateRecordProcess.jsp">
<div class="input-group mb-3">
  <input type="hidden" class="form-control" name="Order_ID" value="<%=resultSet.getString("Order_ID") %>">
</div>
<div class="input-group mb-3">
  <span class="input-group-text" >Product Name</span>
  <input type="text" class="form-control" name="name" value="<%=resultSet.getString("name") %>" disabled>
</div>
<div class="input-group mb-3">
  <span class="input-group-text" >Price</span>
  <input type="text" class="form-control" name="price" value="<%=resultSet.getString("price") %>" disabled>
</div>
<div class="input-group mb-3">
  <span class="input-group-text" >Quantity</span>
  <input type="number" min="1" class="form-control" name="qty" value="<%=resultSet.getString("qty") %>">
</div>
